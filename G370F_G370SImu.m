...
classdef G370F_G370SImu < EpsonDeviceUart
    ...
    properties(GetAccess = 'public', SetAccess = 'private', Hidden=true)
        ...
        SF_ACC = 1/2.5; % Scale factor to convert to mG (milli-gravity)
    ...
    methods
        ...
        function obj = G370F_G370SImu(comport, baudrate, IsPDS0)
        % class constructor
            ...
            obj.getDeviceCfg();
            if not(or(strcmpi(obj.ProdId(1:7), 'G370PDF'), strcmpi(obj.ProdId(1:7), 'G370PDS')))
        ...
        % Will automatically enter CONFIG mode
            ...
            if logical(obj.IsPDS0)
               ...
               obj.SF_GYR = 1/66; % PDFx Scale factor to convert to deg/s
            end
        end
