...
%
% Epson G320 IMU derived from Epson Device Uart handle class

classdef G320Imu < EpsonDeviceUart
    ...
    properties(GetAccess = 'public', SetAccess = 'private', Hidden=true)
        % Scalefactors
        SF_GYR = 1/125; % Scale factor to convert to deg/sec
    ...
    methods
        ...
        function obj = G320Imu(comport, baudrate)
        % class constructor
            ...
            obj.getDeviceCfg();
            if not(strcmpi(obj.ProdId(1:4), 'G320'))
